package com.xgame.godwar.core.login.views
{
	...
	{
		private var btnRegister: CaptionButton;
		...
		{
			super(ResourcePool.instance.getDisplayObject("assets.ui.login.RegisterComponent", null, false) as DisplayObjectContainer);
			btnRegister = getUI(CaptionButton, "btnRegister") as CaptionButton;
			...
			btnRegister.addEventListener(MouseEvent.CLICK, onBtnLoginClick);
		...
		{
			dispatchEvent(new LoginEvent(LoginEvent.REGISTER_CLICK_EVENT));
		}
		
		private function onBtnBackClick(evt: MouseEvent): void
		{
			dispatchEvent(new LoginEvent(LoginEvent.REGISTER_BACK_EVENT));
		}
