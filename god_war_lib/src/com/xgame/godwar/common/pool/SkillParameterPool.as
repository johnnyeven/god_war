package com.xgame.godwar.common.pool
{
	...
	public class SkillParameterPool extends Object implements IPool
	{
		private var _pool: Dictionary;
		private static var _instance: SkillParameterPool;
		private static var _allowInstance: Boolean = false;
		
		public function SkillParameterPool()
		{
			super();
			if(!_allowInstance)
			{
		...
		public static function get instance(): SkillParameterPool
		{
			if(_instance == null)
			{
				_allowInstance = true;
				_instance = new SkillParameterPool();
