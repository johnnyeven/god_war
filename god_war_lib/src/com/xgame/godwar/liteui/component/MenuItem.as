package com.xgame.godwar.liteui.component
{
	...
	import com.xgame.godwar.utils.manager.MenuManager;
	...
	public class MenuItem extends Component
	{
		...
		public function MenuItem(_skin:DisplayObjectContainer=null)
		{
			if(_skin == null)
			{
				_skin = ResourcePool.instance.getDisplayObject("com.xgame.godwar.ui.menu.itemBG", null, false) as DisplayObjectContainer;
			}
			super(_skin);
